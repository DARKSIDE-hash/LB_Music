...
OWNER_ID = int(getenv("OWNER_ID", "1896516271"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/sayarkiduniya")
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/+6MrgQD-RRIA1MTg9")
